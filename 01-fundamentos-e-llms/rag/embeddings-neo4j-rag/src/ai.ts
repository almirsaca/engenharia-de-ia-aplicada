...
export class AI {
    ...
    async retrieveVectorSearchResults(input: ChainState): Promise<ChainState> {
        // Contexto já entregue por quem chamou: pula a busca. Sem isto, o
        // index.ts buscaria duas vezes e a reordenação dele seria descartada.
        if (input.context) {
    ...
    /**
     * @param context Opcional. Fornecido, dispensa a busca vetorial interna —
     *                útil quando quem chama já recuperou e reordenou os trechos.
     */
